...
test_results_folder_absolute_path="${cf_perf_tests_pipeline_repo}/${TEST_RESULTS_FOLDER}"
generated_charts_absolute_path="${cf_perf_tests_pipeline_repo}/${GENERATED_CHARTS_FOLDER}"

echo -e "\nInstalling matplotlib..."
pip install matplotlib

mkdir -p "$generated_charts_absolute_path" "$test_results_folder_absolute_path"

echo -e "\nGenerating charts..."
python "${cf_perf_tests_pipeline_repo}/ci/tasks/generate-charts/generate_charts.py" \
  --test-results "$test_results_folder_absolute_path" --generated-charts "$generated_charts_absolute_path"
